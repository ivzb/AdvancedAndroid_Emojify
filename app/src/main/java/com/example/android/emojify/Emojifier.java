        ...
        if(faces.size() == 0) {
            ...
            for (int i = 0; i < faces.size(); ++i) {
                ...
                switch (whichEmoji(face)) {
                    case SMILE:
                        drawable = R.drawable.smile;
                        break;
                    case FROWN:
                        drawable = R.drawable.frown;
                        break;
                    case LEFT_WINK:
                        drawable = R.drawable.leftwink;
                        break;
                    case RIGHT_WINK:
                        drawable = R.drawable.rightwink;
                        break;
                    case LEFT_WINK_FROWN:
                        drawable = R.drawable.leftwinkfrown;
                        break;
                    case RIGHT_WINK_FROWN:
                        drawable = R.drawable.rightwinkfrown;
                        break;
                    case CLOSED_EYE_SMILE:
                        drawable = R.drawable.closed_smile;
                        break;
                    case CLOSED_EYE_FROWN:
                        drawable = R.drawable.closed_frown;
                        break;
                }

                Bitmap emojiBitmap = BitmapFactory.decodeResource(context.getResources(), drawable);
